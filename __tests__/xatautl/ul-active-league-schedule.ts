...
export async function uploadActiveLeagueSchedule() {
    ...
    for (let season of [
        101995, 98333, 95908, 93330, 90266, 87396, 84635, 80401, 78210, 74865, 67781,
        65438, 63157, 60562,
    ]) {
        await xata.db.seasons.create({
            league_id: 637,
    ...
    for (let season of [98603, 95267, 92111, 88501, 84890, 80261, 75532, 65777]) {
        await xata.db.seasons.create({
            league_id: 4534,
            season_id: season,
            car_id: 106,
    ...
    for (let season of [
        102316, 96115, 96114, 95353, 95115, 89931, 89930, 89421, 87519, 86986, 84315,
        83218, 79987, 79944, 77238, 67144, 67143, 66833, 66832, 64717,
    ]) {
        await xata.db.seasons.create({
            league_id: 3630,
            season_id: season,
